...
import de.walware.statet.rtm.ftable.ui.RtFTableEditorPlugin;


/**
 * This is the action bar contributor for the FTable model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FTableActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(RtFTableEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
		{
			@Override
			public void run() {
				try {
					...
					RtFTableEditorPlugin.INSTANCE.log(exception);
				}
			}
		};
	...
	protected IAction refreshViewerAction =
		new Action(RtFTableEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
		{
			@Override
	 ...
	 * @generated
	 */
	public FTableActionBarContributor() {
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(RtFTableEditorPlugin.INSTANCE.getString("_UI_FTableEditor_menu"), "de.walware.statet.rtm.ftableMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(RtFTableEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(RtFTableEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
	...
	public void menuAboutToShow(final IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(RtFTableEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

		submenuManager = new MenuManager(RtFTableEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
