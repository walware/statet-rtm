...
package de.walware.statet.rtm.ftable.util;
 ...
 * @generated
 */
public class FTableAdapterFactory extends AdapterFactoryImpl {
	/**
	...
	protected FTableSwitch<Adapter> modelSwitch =
		new FTableSwitch<Adapter>() {
			@Override
			public Adapter caseFTable(FTable object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.walware.statet.rtm.ftable.FTable <em>FTable</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFTableAdapter() {
		return null;
	}
