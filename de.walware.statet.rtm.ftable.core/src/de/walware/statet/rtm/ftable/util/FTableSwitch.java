...
public class FTableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FTablePackage.FTABLE: {
				FTable fTable = (FTable)theEObject;
				T result = caseFTable(fTable);
				if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FTable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FTable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFTable(FTable object) {
		return null;
	}
