...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Geom Smooth Layer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.walware.statet.rtm.ggplot.impl.GeomSmoothLayerImpl#getSize <em>Size</em>}</li>
 *   <li>{@link de.walware.statet.rtm.ggplot.impl.GeomSmoothLayerImpl#getColor <em>Color</em>}</li>
 *   <li>{@link de.walware.statet.rtm.ggplot.impl.GeomSmoothLayerImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link de.walware.statet.rtm.ggplot.impl.GeomSmoothLayerImpl#getAlpha <em>Alpha</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class GeomSmoothLayerImpl extends XYVarLayerImpl implements GeomSmoothLayer {
	/**
	...
	protected EClass eStaticClass() {
		return GGPlotPackage.Literals.GEOM_SMOOTH_LAYER;
	}
	...
	public void setAlpha(RTypedExpr newAlpha) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, GGPlotPackage.GEOM_SMOOTH_LAYER__ALPHA, oldAlpha, alpha));
		}
	}
	...
	public void setColor(RTypedExpr newColor) {
		...
		color = newColor;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, GGPlotPackage.GEOM_SMOOTH_LAYER__COLOR, oldColor, color));
		}
	}
	...
	public void setFill(RTypedExpr newFill) {
		...
		fill = newFill;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, GGPlotPackage.GEOM_SMOOTH_LAYER__FILL, oldFill, fill));
		}
	}
	...
	public void setSize(RTypedExpr newSize) {
		...
		size = newSize;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, GGPlotPackage.GEOM_SMOOTH_LAYER__SIZE, oldSize, size));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GGPlotPackage.GEOM_SMOOTH_LAYER__SIZE:
				return getSize();
			case GGPlotPackage.GEOM_SMOOTH_LAYER__COLOR:
				return getColor();
			case GGPlotPackage.GEOM_SMOOTH_LAYER__FILL:
				return getFill();
			case GGPlotPackage.GEOM_SMOOTH_LAYER__ALPHA:
				return getAlpha();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PropSizeProvider.class) {
			switch (derivedFeatureID) {
				case GGPlotPackage.GEOM_SMOOTH_LAYER__SIZE: return GGPlotPackage.PROP_SIZE_PROVIDER__SIZE;
				default: return -1;
			}
		}
		if (baseClass == PropColorProvider.class) {
			switch (derivedFeatureID) {
				case GGPlotPackage.GEOM_SMOOTH_LAYER__COLOR: return GGPlotPackage.PROP_COLOR_PROVIDER__COLOR;
				default: return -1;
			}
		}
		if (baseClass == PropFillProvider.class) {
			switch (derivedFeatureID) {
				case GGPlotPackage.GEOM_SMOOTH_LAYER__FILL: return GGPlotPackage.PROP_FILL_PROVIDER__FILL;
				default: return -1;
			}
		}
		if (baseClass == PropAlphaProvider.class) {
			switch (derivedFeatureID) {
				case GGPlotPackage.GEOM_SMOOTH_LAYER__ALPHA: return GGPlotPackage.PROP_ALPHA_PROVIDER__ALPHA;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PropSizeProvider.class) {
			switch (baseFeatureID) {
				case GGPlotPackage.PROP_SIZE_PROVIDER__SIZE: return GGPlotPackage.GEOM_SMOOTH_LAYER__SIZE;
				default: return -1;
			}
		}
		if (baseClass == PropColorProvider.class) {
			switch (baseFeatureID) {
				case GGPlotPackage.PROP_COLOR_PROVIDER__COLOR: return GGPlotPackage.GEOM_SMOOTH_LAYER__COLOR;
				default: return -1;
			}
		}
		if (baseClass == PropFillProvider.class) {
			switch (baseFeatureID) {
				case GGPlotPackage.PROP_FILL_PROVIDER__FILL: return GGPlotPackage.GEOM_SMOOTH_LAYER__FILL;
				default: return -1;
			}
		}
		if (baseClass == PropAlphaProvider.class) {
			switch (baseFeatureID) {
				case GGPlotPackage.PROP_ALPHA_PROVIDER__ALPHA: return GGPlotPackage.GEOM_SMOOTH_LAYER__ALPHA;
				default: return -1;
			}
		}
