...
/**
 * This is the item provider adapter for a {@link de.walware.statet.rtm.ggplot.GeomSmoothLayer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeomSmoothLayerItemProvider
	 ...
	 * @generated NOT
	 */
	public GeomSmoothLayerItemProvider(AdapterFactory adapterFactory) {
		super(adapterFactory, GGPlotPackage.Literals.GEOM_SMOOTH_LAYER);
	}
	...
	/**
	 * This returns GeomSmoothLayer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeomSmoothLayer")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		RTypedExpr labelValue = ((GeomSmoothLayer)object).getData();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_GeomSmoothLayer_type") : //$NON-NLS-1$
			getString("_UI_GeomSmoothLayer_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeomSmoothLayer.class)) {
			case GGPlotPackage.GEOM_SMOOTH_LAYER__XVAR:
			case GGPlotPackage.GEOM_SMOOTH_LAYER__YVAR:
			case GGPlotPackage.GEOM_SMOOTH_LAYER__GROUP_VAR:
